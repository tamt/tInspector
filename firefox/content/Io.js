/////////////////////////////////////////////////
// Basic  IO object based on Mozilla source 
// code post at forums.mozillazine.org
/////////////////////////////////////////////////

// Example use:
// var fileIn = fInspectorFileIO.open('/test.txt');
// if (fileIn.exists()) {
// 	var fileOut = fInspectorFileIO.open('/copy of test.txt');
// 	var str = fInspectorFileIO.read(fileIn);
// 	var rv = fInspectorFileIO.write(fileOut, str);
// 	alert('File write: ' + rv);
// 	rv = fInspectorFileIO.write(fileOut, str, 'a');
// 	alert('File append: ' + rv);
// 	rv = fInspectorFileIO.unlink(fileOut);
// 	alert('File unlink: ' + rv);
// }

var fInspectorFileIO = {
...
// Example use:
// var dir = fInspectorDirIO.open('/test');
// if (dir.exists()) {
// alert(fInspectorDirIO.path(dir));
// var arr = fInspectorDirIO.read(dir, true), i;
// if (arr) {
...
// }
// else {
// var rv = fInspectorDirIO.create(dir);
...
open : function(path) {
	return fInspectorFileIO.open(path);
},
...
_read : function(dirEntry, recursive) {
	...
	try {
		while (dirEntry.hasMoreElements()) {
			list.push(dirEntry.getNext().QueryInterface(fInspectorFileIO.localfileIID));
		}
		if (recursive) {
			var list2 = new Array();
...
path : function(dir) {
	return fInspectorFileIO.path(dir);
},
