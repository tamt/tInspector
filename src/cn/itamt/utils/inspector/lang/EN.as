...
GEK_ENABLE_POPUP	=	alert error
GEK_DISABLE_POPUP	=	alert error
...
DEval			=	Riaone Deval
DEvalRef		=	DEval References...
DEvalRunTip		=	Inspec a DisplayObject first and then type code in the TextField below. and then click 'run'
runEval			=	run
