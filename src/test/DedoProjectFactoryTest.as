package test {
	 ...
	 */
	public class DedoProjectFactoryTest extends TestCase {

		var xml : XML;
		var project : DedoProject;

		public function DedoProjectFactoryTest(testMethod : String = null) {
			super(testMethod);
		}
		...
		public function testCreateProject() : void {
			...
			assertEqualsArrays(["Dedo", "4.0", 32, 32], [project.name, project.version, project.cellheight, project.cellwidth]);
		}
